...
class ChangeName extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: TAppBar(
        showBackArrow: true,
        title: Text('Атын өзгерту', style: Theme.of(context).textTheme.headlineSmall),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(onPressed: () => controller.updateUserName(), child: const Text('Сақтау')),
            ),
          ],
        ),
      ),
