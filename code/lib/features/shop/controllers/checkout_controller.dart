...
class CheckoutController extends GetxController {
  ...
  @override
  void onInit() {
    selectedPaymentMethod.value = PaymentMethodModel(name: 'Kaspi.kz', image: TImages.paypal);
    super.onInit();
  }
      ...
      builder: (_) => SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              const TSectionHeading(title: 'Төлем түрі', showActionButton: false),
              const SizedBox(height: TSizes.spaceBtwSections),
              TPaymentTile(paymentMethod: PaymentMethodModel(name: 'Kaspi.kz', image: TImages.paypal)),
