...
class OrderController extends GetxController {
  ...
  Future<List<OrderModel>> fetchUserOrders() async {
    try {
      ...
      TLoaders.warningSnackBar(title: 'Oй!', message: e.toString());
      return [];
    }
  }
  ...
  void processOrder(double totalAmount) async {
    try {
      // Start Loader
      TFullScreenLoader.openLoadingDialog('Тапсырысыңыз өңделуде', TImages.pencilAnimation);
      ...
      Get.off(() => SuccessScreen(
            ...
            subTitle: 'Сіздің затыңыз жақында жөнелтіледі!',
