  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          /// -- Heading
          const TSectionHeading(title: 'Категория', textColor: TColors.black, showActionButton: false),
          ...
          Obx(
            () {
              ...
              if (categoryController.featuredCategories.isEmpty) {
                return Center(child: Text('Мәлімет жоқ', style: Theme.of(context).textTheme.bodyMedium!.apply(color: Colors.black)));
              } else {
