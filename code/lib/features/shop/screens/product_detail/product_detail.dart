              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(child: const Text('Тапсырыс беру'), onPressed: () => Get.to(() => const CheckoutScreen())),
                  ),
                  const SizedBox(height: TSizes.spaceBtwSections),

                  /// - Description
                  const TSectionHeading(title: 'Сипаттама', showActionButton: false),
                  ...
                  ReadMoreText(
                    ...
                    trimCollapsedText: ' Көбірек көрсет',
                    trimExpandedText: ' Аздау',
