...
class SearchScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: TAppBar(
        title: Text('Іздеу', style: Theme.of(context).textTheme.headlineMedium),
        actions: [TextButton(onPressed: () => Get.back(), child: const Text('Жабу'))],
      ),
                ...
                children: [
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(prefixIcon: Icon(Iconsax.search_normal), hintText: 'Іздеу'),
                    ),
                  ),
  ...
  Column brandsAndCategories(BuildContext context) {
    ...
    return Column(
      children: [
        /// Brands Heading
        const TSectionHeading(title: 'Брендтер', showActionButton: false),
        ...
        /// Categories
        const TSectionHeading(title: 'Категориялар', showActionButton: false),
        ...
        Obx(
          () {
            ...
            if (categoryController.allCategories.isEmpty) {
              return Center(child: Text('Деректер табылмады!', style: Theme.of(context).textTheme.bodyMedium!.apply(color: Colors.white)));
            } else {
              /// Data Found
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  const TSectionHeading(title: 'Фильтр', showActionButton: false),
              ...
              /// Sort
              Text('Сұрыптау', style: Theme.of(context).textTheme.titleLarge),
              ...
              Text('Категория', style: Theme.of(context).textTheme.titleLarge),
              const SizedBox(height: TSizes.spaceBtwItems),
              _buildCategoryList(),
              const SizedBox(height: TSizes.spaceBtwSections),

              /// Sort by Radios
              Text('Бағасы', style: Theme.of(context).textTheme.titleLarge),
              const SizedBox(height: TSizes.spaceBtwItems / 2),
              Row(
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(hintText: 'тг-ден кіші'),
                    ),
                  ),
                  const SizedBox(width: TSizes.spaceBtwItems),
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(hintText: 'тг-ден көп'),
                    ),
                  ),
                ],
              ),
